...
$SUDO yes | apt-get -o Dpkg::Options::="--force-confold" -fuy install software-properties-common curl git python3 python3-setuptools python3-apt python3-pip ansible python3-passlib python3-wheel python3-bcrypt aptitude -y;
